    ...
    <>
      ...
      <style jsx>{`
        ...
        .hero-badge {
          ...
          font-size: 0.8rem; color: #c4b5fd; font-weight: 500;
          margin-bottom: 2rem;
        }
        ...
        .btn-ghost {
          ...
          border-radius: 12px; color: rgba(255,255,255,0.75); font-weight: 600;
          font-size: 1rem; text-decoration: none;
        ...
        /* SECTIONS */
        .how-section, .urls-section, .final-cta {
          position: relative; z-index: 2;
